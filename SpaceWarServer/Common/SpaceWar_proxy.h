...
namespace SpaceWar
{
	...
	virtual bool RequestOxyUpdate ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext ,  const float & oxy) PN_SEALED; 
	virtual bool RequestOxyUpdate ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext,  const float & oxy)   PN_SEALED;  
	...
	virtual bool NotifyNetworkObjectCreate ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext ,  const string & networkID,  const int & type,  const Proud::Vector3 & pos,  const Proud::Vector3 & rot) PN_SEALED; 
	virtual bool NotifyNetworkObjectCreate ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext,  const string & networkID,  const int & type,  const Proud::Vector3 & pos,  const Proud::Vector3 & rot)   PN_SEALED;  
	virtual bool NotifyNetworkObjectMove ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext ,  const string & networkID,  const Proud::Vector3 & pos,  const Proud::Vector3 & velocity,  const Proud::Vector3 & rot) PN_SEALED; 
	virtual bool NotifyNetworkObjectMove ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext,  const string & networkID,  const Proud::Vector3 & pos,  const Proud::Vector3 & velocity,  const Proud::Vector3 & rot)   PN_SEALED;  
	virtual bool NotifyNetworkObjectDelete ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext ,  const string & networkID) PN_SEALED; 
	virtual bool NotifyNetworkObjectDelete ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext,  const string & networkID)   PN_SEALED;  
	virtual bool RequestMeteorCreate ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext ,  const Proud::Vector3 & pos) PN_SEALED; 
	virtual bool RequestMeteorCreate ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext,  const Proud::Vector3 & pos)   PN_SEALED;  
	...
	virtual bool RequestSpaceShipSetup ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext ,  const int & spaceShipID) PN_SEALED; 
	virtual bool RequestSpaceShipSetup ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext,  const int & spaceShipID)   PN_SEALED;  
	...
	virtual bool RequestUseSpaceShipCancel ( ::Proud::HostID remote, ::Proud::RmiContext& rmiContext ,  const int & spaceShipID) PN_SEALED; 
	virtual bool RequestUseSpaceShipCancel ( ::Proud::HostID *remotes, int remoteCount, ::Proud::RmiContext &rmiContext,  const int & spaceShipID)   PN_SEALED;  
