...
public class ExamplesController : MonoBehaviour {
	...
	public void ExposureChanged(Slider slider) {
		...
		//
		UnityStandardAssets.ImageEffects.Tonemapping tm = mainCamera.gameObject.GetComponent<UnityStandardAssets.ImageEffects.Tonemapping> ();
		tm.exposureAdjustment = slider.value;
	}
