Shader "UBER - DynSnow - Specular Setup/Tessellation/Refraction/Two Layers"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "SNOW"="On" "TESS"="On" "REFR"="On" "BEND_NORM"="Off" "TWO_LAYERS"="On"}
		LOD 700
	...
	FallBack "UBER - DynSnow - Specular Setup/Refraction/Two Layers"
