Shader "UBER - DynSnow - Specular Setup/Refraction/POM Extrusion Map"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "SNOW"="On" "REFR"="On" "TWO_LAYERS"="Off" "POM_EXTRUSION_MAP"="On"}
		LOD 700
		...
		Pass
		{
			...
			#pragma shader_feature _POM_EXTRUSION_MAP _POM_EXTRUSION_MAP_ZWRITE _POM_EXTRUSION_MAP_SHADOWS
		...
		*/			
		...
		Pass {
			...
			#pragma multi_compile _POM_EXTRUSION_MAP _POM_EXTRUSION_MAP_ZWRITE
