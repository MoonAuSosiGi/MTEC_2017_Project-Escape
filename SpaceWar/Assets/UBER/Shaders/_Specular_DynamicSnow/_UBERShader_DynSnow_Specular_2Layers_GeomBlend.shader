Shader "UBER - DynSnow - Specular Setup/(RTP's Geom Blend)/Two Layers"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "SNOW"="On" "REFR"="Off" "TWO_LAYERS"="On" "GEOM_BLEND"="On"}
		LOD 700
		Offset -1,-1
		ZTest LEqual	
