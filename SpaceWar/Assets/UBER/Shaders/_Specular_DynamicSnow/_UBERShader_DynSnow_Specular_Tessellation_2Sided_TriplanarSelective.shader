Shader "UBER - DynSnow - Specular Setup/Tessellation/2 Sided/ Triplanar Selective"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "SNOW"="On" "TESS"="On" "REFR"="Off" "TWO_LAYERS"="Off" "TRIPLANAR"="On"}
		LOD 700
	...
	FallBack "UBER - DynSnow - Specular Setup/ Triplanar Selective"
