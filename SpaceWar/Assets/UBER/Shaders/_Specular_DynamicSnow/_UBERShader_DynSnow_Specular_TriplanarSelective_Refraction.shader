Shader "UBER - DynSnow - Specular Setup/Refraction/Triplanar Selective"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "PerformanceChecks"="False" "SNOW"="On" "REFR"="On" "TWO_LAYERS"="Off" "TRIPLANAR"="On"}
		LOD 700
