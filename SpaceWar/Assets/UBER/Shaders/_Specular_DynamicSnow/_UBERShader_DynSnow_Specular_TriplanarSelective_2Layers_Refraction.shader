Shader "UBER - DynSnow - Specular Setup/Refraction/Triplanar Selective - Two Layers"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "PerformanceChecks"="False" "SNOW"="On" "REFR"="On" "TWO_LAYERS"="On" "TRIPLANAR"="On"}
		LOD 700
