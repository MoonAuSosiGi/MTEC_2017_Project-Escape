Shader "UBER - DynSnow - Specular Setup/Refraction/POM Advanced"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "SNOW"="On" "REFR"="On" "TWO_LAYERS"="Off" "SILHOUETTE_CURVATURE"="On"}
		LOD 700
		...
		Pass
		{
			...
			#pragma shader_feature SILHOUETTE_CURVATURE_BASIC SILHOUETTE_CURVATURE_MAPPED
			#define POM_UV_BORDER_CLIP
			//#pragma shader_feature _NORMALMAP

			// keywords available in regular mode
			#pragma shader_feature ___ _PARALLAX_POM _PARALLAX_POM_ZWRITE _PARALLAX_POM_SHADOWS
		...
		*/	
		...
		Pass
		{
			...
			// adv POM means normalmap enabled
			//#pragma shader_feature _NORMALMAP
