Shader "UBER - DynSnow - Specular Setup/Refraction/Core - simple (no normalmap)"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "PerformanceChecks"="False" "SNOW"="On" "REFR"="On" "TWO_LAYERS"="Off" "NONORMAL"="On"}
		LOD 700
