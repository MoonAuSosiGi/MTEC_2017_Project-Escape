Shader "UBER - DynSnow - Specular Setup/Tessellation/2 Sided/ Two Layers"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "SNOW"="On" "TESS"="On" "REFR"="Off" "BEND_NORM"="Off" "TWO_LAYERS"="On"}
		LOD 700
	...
	FallBack "UBER - DynSnow - Specular Setup/ Two Layers"
