Shader "UBER - DynSnow - Specular Setup/ POM Advanced"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "SNOW"="On" "REFR"="Off" "TWO_LAYERS"="Off" "SILHOUETTE_CURVATURE"="On"}
		LOD 700
