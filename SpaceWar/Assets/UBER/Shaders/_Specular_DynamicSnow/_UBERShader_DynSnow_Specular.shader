Shader "UBER - DynSnow - Specular Setup/ Core"
{
	Properties
	{
		...
		[Enum(Hide Layers A and B,0, Show Layer A,1, Show Layer B,2, Show all decals,3)]_DecalMaskForSnowGUI("Decal mask for snow (GUI)", Float) = 0
		_DecalMaskForSnow("Decal Mask for snow", Float) = 0 // 0, 0.3, 0.8, 1 
		_DecalMaskForSnowThreshold("Decal Mask for snow threshold ", Range(0,1)) = 0.5
		...
		[Enum(UV0,0,UV1,1,WorldMap,2)] _UVSec ("UV Set for secondary textures", Float) = 0
        ...
        // snow
        [NoKeywordToggle] _Snow ("Snow", Float) = 1
		...
		// (new micro tiling double)
		[NoKeywordToggle] _SnowBumpMicro2Used ("Bumps micro 2nd used", Float) = 0
		_SnowMicroTiling2 ("Micro tiling 2nd", Float) = 4
		_SnowBumpMicro2 ("Bumps micro 2nd", Range(0.001, 0.2)) = 0.08
		//
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "SNOW"="On" "REFR"="Off" "TWO_LAYERS"="Off"}
		LOD 700
		...
		*/			
		...
		Pass
		{
			...
			#pragma shader_feature _OCCLUSION_FROM_ALBEDO_ALPHA
