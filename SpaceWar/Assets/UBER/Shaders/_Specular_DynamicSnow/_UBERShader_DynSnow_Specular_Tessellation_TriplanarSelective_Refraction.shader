Shader "UBER - DynSnow - Specular Setup/Tessellation/Refraction/Triplanar Selective"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "PerformanceChecks"="False" "SNOW"="On" "TESS"="On" "REFR"="On" "TWO_LAYERS"="Off" "TRIPLANAR"="On"}
		LOD 700
	...
	FallBack "UBER - DynSnow - Specular Setup/Refraction/Triplanar Selective"
