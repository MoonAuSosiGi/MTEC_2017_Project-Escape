Shader "UBER - DynSnow - Specular Setup/2 Sided/ Triplanar Selective"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "SNOW"="On" "REFR"="Off" "TWO_LAYERS"="Off" "TRIPLANAR"="On"}
		LOD 700
