#ifndef UBER_STANDARD_BRDF_INCLUDED
#define UBER_STANDARD_BRDF_INCLUDED
...
{
	half t = exp2(-8.65*cosA); // UBER - 2 ops instead of 5
...
#if !defined(_MAX_SMOOTHNTESS_SPEC)
	#define _MAX_SMOOTHNTESS_SPEC 1.0
#endif
#if UNITY_BRDF_GGX
	half V = SmithJointGGXVisibilityTerm (nl, nv, roughness);
	half D = GGXTerm (nh, roughness*_MAX_SMOOTHNTESS_SPEC + (1.0 - _MAX_SMOOTHNTESS_SPEC));
#else
...
#endif // UBER_STANDARD_BRDF_INCLUDED
