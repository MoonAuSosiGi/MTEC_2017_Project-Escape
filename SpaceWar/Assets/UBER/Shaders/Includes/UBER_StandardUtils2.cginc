...
// init actH if needed
	...
	return texcoords;
				...
				float2 offset = ParallaxOffset1Step (actH, lerp(_Parallax2, _Parallax, i_vertex_color.VERTEX_COLOR_CHANNEL_LAYER), viewDir);
			#else
				float2 offset = ParallaxOffset1Step (actH, lerp(_Parallax2, _Parallax, i_vertex_color.r), viewDir);
			#endif
		#else
			float2 offset = ParallaxOffset1Step (actH, _Parallax, viewDir);
		#endif
