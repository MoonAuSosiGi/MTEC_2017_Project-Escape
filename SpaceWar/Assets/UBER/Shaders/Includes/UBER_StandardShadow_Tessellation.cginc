...
void fragShadowCaster (
	...
	#endif
	// point lights doesn't need to write into depth (they encode depth into float cube texture)
	#if defined (ZWRITE) && !defined(SHADOWS_CUBE)
	...
	)
{
	...
	output = 0.5;
		...
		#if defined(SHADOWS_CUBE)
			//
			//shader part not currently used on tested platforms (DX9, DX11, OGL desktop) - for point light it's casted to the cube texture above)
			//	
//			// point light shadow caster 
