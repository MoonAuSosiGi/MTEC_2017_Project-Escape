...
#include "../Includes/UBER_PBSLighting.cginc" // TBD: remove
...
#if (_NORMALMAP || !DIRLIGHTMAP_OFF || _PARALLAXMAP || _PARALLAXMAP_2MAPS || _PARALLAX_POM || _PARALLAX_POM_ZWRITE || _PARALLAX_POM_SHADOWS || defined(DISTANCE_MAP) || defined(EXTRUSION_MAP) || !defined(_WETNESS_NONE) || defined(_SNOW))
