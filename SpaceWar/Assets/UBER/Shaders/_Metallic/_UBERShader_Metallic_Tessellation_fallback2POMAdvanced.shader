Shader "UBER - Metallic Setup/Tessellation/ Core (fallback to POM Advanced)"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "TESS"="On" "REFR"="Off" "TWO_LAYERS"="Off"}
		LOD 700
	...
	FallBack "UBER - Metallic Setup/ POM Advanced"
