Shader "UBER - Metallic Setup/Tessellation/Refraction/Triplanar Selective - Two Layers"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "PerformanceChecks"="False" "TESS"="On" "REFR"="On" "TWO_LAYERS"="On" "TRIPLANAR"="On"}
		LOD 700
	...
	FallBack "UBER - Metallic Setup/Refraction/Triplanar Selective - Two Layers"
