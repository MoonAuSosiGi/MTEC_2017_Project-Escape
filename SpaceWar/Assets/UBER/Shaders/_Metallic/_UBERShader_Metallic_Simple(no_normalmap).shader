Shader "UBER - Metallic Setup/ Core - simple (no normalmap)"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "REFR"="Off" "TWO_LAYERS"="Off" "NONORMAL"="On"}
		LOD 700
