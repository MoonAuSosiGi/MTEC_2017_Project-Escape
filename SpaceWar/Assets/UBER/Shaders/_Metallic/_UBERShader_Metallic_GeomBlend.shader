Shader "UBER - Metallic Setup/(RTP's Geom Blend)/Core"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+12" "PerformanceChecks"="False" "REFR"="Off" "TWO_LAYERS"="Off" "GEOM_BLEND"="On"}
		LOD 700
