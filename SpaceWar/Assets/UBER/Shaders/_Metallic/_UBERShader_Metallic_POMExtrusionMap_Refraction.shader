Shader "UBER - Metallic Setup/Refraction/POM Extrusion Map"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "REFR"="On" "TWO_LAYERS"="Off" "POM_EXTRUSION_MAP"="On"}
		LOD 700
