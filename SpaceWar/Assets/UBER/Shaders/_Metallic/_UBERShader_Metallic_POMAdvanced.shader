Shader "UBER - Metallic Setup/ POM Advanced"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "REFR"="Off" "TWO_LAYERS"="Off" "SILHOUETTE_CURVATURE"="On"}
		LOD 700
