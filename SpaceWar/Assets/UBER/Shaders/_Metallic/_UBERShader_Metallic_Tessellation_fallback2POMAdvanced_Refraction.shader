Shader "UBER - Metallic Setup/Tessellation/Refraction/Core (fallback to POM Advanced)"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "PerformanceChecks"="False" "TESS"="On" "REFR"="On" "TWO_LAYERS"="Off"}
		LOD 700
	...
	FallBack "UBER - Metallic Setup/Refraction/POM Advanced"
