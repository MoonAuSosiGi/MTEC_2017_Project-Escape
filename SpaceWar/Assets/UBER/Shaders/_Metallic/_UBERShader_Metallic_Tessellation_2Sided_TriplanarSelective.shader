Shader "UBER - Metallic Setup/Tessellation/2 Sided/ Triplanar Selective"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "TESS"="On" "REFR"="Off" "TWO_LAYERS"="Off" "TRIPLANAR"="On"}
		LOD 700
	...
	FallBack "UBER - Metallic Setup/ Triplanar Selective"
