Shader "UBER - Metallic Setup/(RTP's Geom Blend)/Triplanar Selective - Two Layers"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+12" "PerformanceChecks"="False" "REFR"="Off" "TWO_LAYERS"="On" "TRIPLANAR"="On" "GEOM_BLEND"="On"}
		LOD 700
		Offset -1,-1
		ZTest LEqual	
