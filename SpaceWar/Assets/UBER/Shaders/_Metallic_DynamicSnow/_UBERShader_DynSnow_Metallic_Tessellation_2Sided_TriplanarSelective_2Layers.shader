Shader "UBER - DynSnow - Metallic Setup/Tessellation/2 Sided/ Triplanar Selective - Two Layers"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "SNOW"="On" "TESS"="On" "REFR"="Off" "BEND_NORM"="Off" "TWO_LAYERS"="On" "TRIPLANAR"="On"}
		LOD 700
	...
	FallBack "UBER - DynSnow - Metallic Setup/ Triplanar Selective - Two Layers"
