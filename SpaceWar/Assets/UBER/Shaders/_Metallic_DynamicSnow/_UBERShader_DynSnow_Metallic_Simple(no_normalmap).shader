Shader "UBER - DynSnow - Metallic Setup/ Core - simple (no normalmap)"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "SNOW"="On" "REFR"="Off" "TWO_LAYERS"="Off" "NONORMAL"="On"}
		LOD 700
		...
		*/	
		...
		Pass
		{
			...
			//#pragma shader_feature _NORMALMAP 0
