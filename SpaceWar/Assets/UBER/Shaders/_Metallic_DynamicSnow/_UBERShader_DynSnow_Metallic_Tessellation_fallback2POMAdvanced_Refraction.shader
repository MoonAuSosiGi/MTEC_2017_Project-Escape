Shader "UBER - DynSnow - Metallic Setup/Tessellation/Refraction/Core (fallback to POM Advanced)"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "PerformanceChecks"="False" "SNOW"="On" "TESS"="On" "REFR"="On" "TWO_LAYERS"="Off"}
		LOD 700
	...
	FallBack "UBER - DynSnow - Metallic Setup/Refraction/POM Advanced"
