Shader "UBER - DynSnow - Metallic Setup/Refraction/POM Distance Map"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "SNOW"="On" "REFR"="On" "TWO_LAYERS"="Off" "POM_DISTANCE_MAP"="On"}
		LOD 700
		...
		Pass
		{
			...
			#pragma shader_feature _POM_DISTANCE_MAP _POM_DISTANCE_MAP_ZWRITE _POM_DISTANCE_MAP_SHADOWS
		...
		*/			
		...
		Pass {
			...
			#pragma multi_compile _POM_DISTANCE_MAP _POM_DISTANCE_MAP_ZWRITE
