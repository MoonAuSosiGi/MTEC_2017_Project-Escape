Shader "UBER - DynSnow - Metallic Setup/ POM Distance Map"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "SNOW"="On" "REFR"="Off" "TWO_LAYERS"="Off" "POM_DISTANCE_MAP"="On"}
		LOD 700
