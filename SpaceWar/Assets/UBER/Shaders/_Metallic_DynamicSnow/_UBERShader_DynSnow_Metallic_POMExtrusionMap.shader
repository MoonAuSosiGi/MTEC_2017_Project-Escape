Shader "UBER - DynSnow - Metallic Setup/ POM Extrusion Map"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "SNOW"="On" "REFR"="Off" "TWO_LAYERS"="Off" "POM_EXTRUSION_MAP"="On"}
		LOD 700
