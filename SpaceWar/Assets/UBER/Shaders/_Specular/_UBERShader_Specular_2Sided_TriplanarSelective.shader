Shader "UBER - Specular Setup/2 Sided/ Triplanar Selective"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "REFR"="Off" "TWO_LAYERS"="Off" "TRIPLANAR"="On"}
		LOD 700
