Shader "UBER - Specular Setup/Tessellation/2 Sided/ Two Layers"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "TESS"="On" "REFR"="Off" "BEND_NORM"="Off" "TWO_LAYERS"="On"}
		LOD 700
	...
	FallBack "UBER - Specular Setup/ Two Layers"
