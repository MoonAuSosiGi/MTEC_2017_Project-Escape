Shader "UBER - Specular Setup/Tessellation/Refraction/Two Layers"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "TESS"="On" "REFR"="On" "BEND_NORM"="Off" "TWO_LAYERS"="On"}
		LOD 700
	...
	FallBack "UBER - Specular Setup/Refraction/Two Layers"
