Shader "UBER - Specular Setup/Tessellation/2 Sided/ Triplanar Selective - Two Layers"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "TESS"="On" "REFR"="Off" "BEND_NORM"="Off" "TWO_LAYERS"="On" "TRIPLANAR"="On"}
		LOD 700
	...
	FallBack "UBER - Specular Setup/ Triplanar Selective - Two Layers"
