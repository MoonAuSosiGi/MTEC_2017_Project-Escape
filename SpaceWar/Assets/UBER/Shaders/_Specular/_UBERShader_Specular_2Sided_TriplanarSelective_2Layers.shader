Shader "UBER - Specular Setup/2 Sided/ Triplanar Selective - Two Layers"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "REFR"="Off" "TWO_LAYERS"="On" "TRIPLANAR"="On"}
		LOD 700
