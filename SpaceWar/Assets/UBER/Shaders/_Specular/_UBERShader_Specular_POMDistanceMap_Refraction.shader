Shader "UBER - Specular Setup/Refraction/POM Distance Map"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+1" "PerformanceChecks"="False" "REFR"="On" "TWO_LAYERS"="Off" "POM_DISTANCE_MAP"="On"}
		LOD 700
