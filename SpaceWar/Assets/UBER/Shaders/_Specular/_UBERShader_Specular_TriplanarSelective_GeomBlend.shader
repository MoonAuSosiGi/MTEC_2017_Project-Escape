Shader "UBER - Specular Setup/(RTP's Geom Blend)/Triplanar Selective"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Opaque" "Queue"="Geometry+12" "PerformanceChecks"="False" "REFR"="Off" "TWO_LAYERS"="Off" "TRIPLANAR"="On" "GEOM_BLEND"="On"}
		LOD 700
		Offset -1,-1
		ZTest LEqual	
